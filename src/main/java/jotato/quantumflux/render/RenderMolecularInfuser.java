...
public class RenderMolecularInfuser extends RenderBlockBase
{
	@Override
...
//			}
		...
		} else
		{
			...
			renderer.renderMaxX = .99995;
			renderer.renderMaxY = .99995;
			renderer.renderMaxZ = .99995;
			renderer.renderMinX = .00005;
			renderer.renderMinY = .00005;
			renderer.renderMinZ = .00005;
			renderer.renderFromInside = false;
			renderer.renderStandardBlock(QFBlocks.molecularInfuser, x, y, z);
	...
	{
		return BlockMolecularInfuser.renderType;
	}
