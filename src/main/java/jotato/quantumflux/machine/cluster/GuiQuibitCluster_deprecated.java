...
public class GuiQuibitCluster_deprecated extends GuiContainer
{
    ...
    public GuiQuibitCluster_deprecated(EntityPlayer player, TileEntityQuibitCluster_Deprecated cluster)
    {
        super(new ContainerQuibitCluster_deprecated(player, cluster));
