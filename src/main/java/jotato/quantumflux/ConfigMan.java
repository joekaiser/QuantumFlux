...
public class ConfigMan
{
    ...
    public static void hydrateConifg()
    {
        ...
        imaginaryTime_energyRequirement =config.getInt("energyRequirement", "imaginaryTime", 400, 50, 1000, "How much energy is used per work cycle. The higher the number the more RF must be pumped in before work will be done");
