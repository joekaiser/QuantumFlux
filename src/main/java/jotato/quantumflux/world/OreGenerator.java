...
public class OreGenerator implements IWorldGenerator {
	...
	public OreGenerator() {
		if (ConfigMan.enableTitaniumGen) {
			WorldGenSparseMinableCluster titaniumGen = new WorldGenSparseMinableCluster(
					new ItemStack(ModBlocks.titaniumOre), 4, Blocks.stone);
			generators.add(new WorldGenInfo(titaniumGen, 7, 13, 6, .2));
		}
	}
