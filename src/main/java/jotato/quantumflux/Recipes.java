...

{
    ...
    ItemStack crystalizedRedstone = new ItemStack(QFItems.crystalizedRedstone);
    ...
    private void shapedRecipes()
    {
        ...
        GameRegistry.addRecipe(new ShapedOreRecipe(new ItemStack(QFItems.quibitCrystal, 4), " r ", "qdq", " r ", 'r', redstone, 'q', quartz, 'd', diamond));
        ...
        GameRegistry.addRecipe(new ShapedOreRecipe(new ItemStack(QFItems.manganese), "grg", "rir", "grg", 'r', redstone, 'i', ironIngot, 'g', goldNugget));
        GameRegistry.addRecipe(new ShapedOreRecipe(new ItemStack(QFItems.mangalloy), "sss", "sms", "sss", 's', steelIngot, 'm', manganese));

        GameRegistry.addRecipe(new ShapedOreRecipe(new ItemStack(QFItems.zbq7), "rlr", "gdg", "rlr", 'r', redstoneBlock, 'l', lapisBlock, 'g', goldBlock, 'd', diamondBlock));
        GameRegistry
                .addRecipe(new ShapedOreRecipe(new ItemStack(QFBlocks.rfEntangler), "zaz", "zqz", "mmm", 'm', mangalloy, 'a', amplificationCrystal, 'q', quibitCluster_4, 'z', zbq7));
        GameRegistry.addRecipe(new ShapedOreRecipe(new ItemStack(QFBlocks.rfExciter, 4), "qeq", "sgs", 'q', quibitCrystal, 'e', enderPearl, 's', steelIngot, 'g', goldCasing));
        GameRegistry.addRecipe(new ShapedOreRecipe(new ItemStack(QFItems.quibitCell), "eae", "aqa", "eae", 'q', quibitCluster_2, 'e', rfExciter, 'a', amplificationCrystal));
        GameRegistry.addRecipe(new ShapedOreRecipe(new ItemStack(QFItems.magnet), "r l", "a a", " m ", 'l', lapis, 'r', redstone, 'a', amplificationCrystal, 'm', mangalloy));
        GameRegistry.addRecipe(new ShapedOreRecipe(new ItemStack(QFItems.energizedCrystal, 4), "zcz", "csc", "zcz", 'c', quibitCrystal, 'z', zbq7, 's', netherStar));
        ...
        GameRegistry.addRecipe(new ShapedOreRecipe(new ItemStack(QFItems.exciterUpgrade,2), "c c", " q ", "sss", 'c', crystalizedRedstone, 'q', quibitCrystal,'s',stone));
        ...
        {
            GameRegistry.addRecipe(new ShapedOreRecipe(new ItemStack(QFBlocks.zpe), "aza", "cqc", "mmm", 'm', mangalloy, 'z', zbq7, 'a', amplificationCrystal, 'q', quibitCluster_1,
                    'c', quibitCrystal));
        }
    }
    ...
    private void shapelessRecipes()
    {
        ...
        GameRegistry.addRecipe(new ShapelessOreRecipe(ItemBattleSuit.newArmorPiece(QFItems.battlesuit_chest, 1, true), upgradeToken, feather, ItemBattleSuit.newArmorPiece(
                QFItems.battlesuit_chest, 0, true)));
        GameRegistry.addRecipe(new ShapelessOreRecipe(ItemBattleSuit.newArmorPiece(QFItems.battlesuit_boots, 1, true), upgradeToken, redstone, ItemBattleSuit.newArmorPiece(
                QFItems.battlesuit_boots, 0, true)));
        GameRegistry.addRecipe(new ShapelessOreRecipe(ItemBattleSuit.newArmorPiece(QFItems.battlesuit_legs, 1, true), upgradeToken, lapis, ItemBattleSuit.newArmorPiece(
                QFItems.battlesuit_legs, 0, true)));
        GameRegistry.addRecipe(new ShapelessOreRecipe(ItemBattleSuit.newArmorPiece(QFItems.battlesuit_helm, 1, true), upgradeToken, spiderEye, ItemBattleSuit.newArmorPiece(
                QFItems.battlesuit_helm, 0, true)));
    }
